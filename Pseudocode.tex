...
\end{algorithm}
  ...
  \begin{algorithm}
   \caption{Iterative Dichotomiser 3 ~\cite{id3algo1} Link:{12,14,56,74,131,140}}
    \begin{algorithmic}[1]
...
\end{algorithm}
 ...
 \begin{algorithm}
   ...
   \caption{C4.5  ~\cite{c4.5} Link :18,63,80,107,109,110,111,129 }
    \begin{algorithmic}[1]
    \INPUT{
...
\end{algorithm}
 ...
 \begin{algorithm}
   ...
   \caption{Naive Bayes ~\cite{naivebayes1} Link: 9, 59 }
    \begin{algorithmic}[1]
    \INPUT{
...
\end{algorithm}
 ...
 \begin{algorithm}
   ...
   \caption{Deep Q-Learning with Experience Replay ~\cite{{DBLP:journals/corr/MnihKSGAWR13}} Link: 91 }
    \begin{algorithmic}[1]
...
\end{algorithm}
 ...
 \begin{algorithm}
   ...
   \caption{PageRank ~\cite{pagerank1} Link:24,64,98,99 }
    \begin{algorithmic}[1]
...
\begin{algorithm}
 \caption{K means ~\cite{kmeans1} Link:21,31,46,147   }
    \begin{algorithmic}[1]
...
\begin{algorithm}
 \caption{K means ~\cite{kmeans2} Link:25,29,40,104   }
    \begin{algorithmic}[1]
...
\begin{algorithm}
   ...
   \caption{DBSCAN link:{13,76,97}  ~\cite{dbscan1
   }  }
    \begin{algorithmic}[1]
    \INPUT{
    \Statex $D$: Data
