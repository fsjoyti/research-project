...
\begin{algorithm}
   \caption{Hidden Markov Models - The forward algorithm ~\cite{ jurafsky_martin_2008} }
 \begin{algorithmic}[1]
  \INPUT 
...
\begin{algorithm}
   \caption{ Hidden Markov Models - The Viterbi algorithm ~\cite{ jurafsky_martin_2008}
    }
